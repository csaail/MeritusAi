...
Blockly.Msg["PLUTO_BASIC_FOREVER"] = "forever";  // untranslated
Blockly.Msg["PLUTO_BASIC_ON_START"] = "on start";  // untranslated
Blockly.Msg["PLUTO_BASIC_ON_STOP"] = "on stop";  // untranslated
...
Blockly.Msg["TOOLTIPS_BY_AXIS_BARO_PRESSURE"] = "Returns Pressure (Units: 100*millibar) value.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_BARO_TEMP"] = "Returns Temperature (Units: 100*degree centigrade) value.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_GYRO_X"] = "Returns Angular Rate (rate of change of angle) values in X axis (Units: deciDegrees/s).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_GYRO_Y"] = "Returns Angular Rate (rate of change of angle) values in Y axis(Units: deciDegrees/s).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_GYRO_Z"] = "Returns Angular Rate (rate of change of angle) values in Z axis (Units: deciDegrees/s).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_MAG_X"] = "Returns Magnetic Field values in X axis (Units: microTesla).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_MAG_Y"] = "Returns Magnetic Field values in Y axis (Units: microTesla).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_MAG_Z"] = "Returns Magnetic Field values in Z axis (Units: microTesla).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_NET_ACC"] = "Returns Proper Acceleration values in Strength (RMS) axis (Units: cm/s2).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_X"] = "Returns Proper Acceleration values in X axis (Units: cm/s2).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_Y"] = "Returns Proper Acceleration values in Y axis (Units: cm/s2).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_AXIS_Z"] = "Returns Proper Acceleration values in Z axis (Units: cm/s2).";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_BLUE_OFF"] = "Set Blue LED in OFF state.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_BLUE_ON"] = "Set Blue LED in ON state.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_BLUE_TOGGLE"] = "Set Blue LED in TOGGLE state.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_GREEN_OFF"] = "Set Green LED in OFF state.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_GREEN_ON"] = "Set Green LED in ON state.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_GREEN_TOGGLE"] = "Set Green LED in TOGGLE state.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_OFF"] = "Set Red LED in OFF state.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_ON"] = "Set Red LED in ON state.";  // untranslated
Blockly.Msg["TOOLTIPS_BY_STATE_TOGGLE"] = "Set Red LED in TOGGLE state.";  // untranslated
Blockly.Msg["TOOLTIP_BY_BOOL_GET"] = "Returns boolean value (true/false) of '%1' variable.";  // untranslated
Blockly.Msg["TOOLTIP_BY_BOOL_SET"] = "Sets boolean value (true/false) to '%1' variable.";  // untranslated
Blockly.Msg["TOOLTIP_BY_CHECK_TIMER"] = "Returns boolean value (True or False) depending on whether '%1' has comepleted the counting or not.";  // untranslated
Blockly.Msg["TOOLTIP_BY_FLOAT_GET"] = "Returns float value of '%1' variable.";  // untranslated
Blockly.Msg["TOOLTIP_BY_FLOAT_SET"] = "Sets float value to '%1' variable.";  // untranslated
Blockly.Msg["TOOLTIP_BY_INT_GET"] = "Returns integer value of '%1' variable.";  // untranslated
Blockly.Msg["TOOLTIP_BY_INT_SET"] = "Sets integer value to '%1' variable.";  // untranslated
Blockly.Msg["TOOLTIP_BY_RESET_TIMER"] = "Resets '%1' back to zero.";  // untranslated
Blockly.Msg["TOOLTIP_BY_SET_TIMER"] = "Set time (Range: 0 - 5000 milliseconds) and to repeat or not (True or False) for '%1'.";  // untranslated
